    ...
    <div class="container">
      ...
      <div class="flex">
        <div class="item">
          ...
          <p class="copyable-address" id="clinic-address">
            〒160-0022<br>
            東京都新宿区新宿6丁目29-11<br>
            新宿イーストクロスタワー3F<br>
            <button type="button" class="copy-btn" data-copy="#clinic-address">
              <img src="<?php my_theme_uri(); ?>/assets/images/common/file_copy.webp" alt="" />
            </button>
          </p>
